...
public class LoginPageControllerTest {
	...
	/**
	 * @see org.openmrs.module.imbemr.page.controller.LoginPageController#get(org.openmrs.ui.framework.page.PageModel,
	...
	public void get_shouldRedirectTheUserToTheHomePageIfTheyAreAlreadyAuthenticated() throws Exception {
		...
		String homeRedirect = "redirect:" + uiUtils.pageLink(ImbEmrConstants.MODULE_ID, "home");
	...
	public void post_shouldRedirectTheUserToTheHomePageIfTheRedirectUrlIsTheLoginPage() throws Exception {
		...
		final String redirectUrl = uiUtils.pageLink(ImbEmrConstants.MODULE_ID, "login");
		final String homeRedirect = "redirect:" + uiUtils.pageLink(ImbEmrConstants.MODULE_ID, "home");
		MockHttpServletRequest request = new MockHttpServletRequest();
