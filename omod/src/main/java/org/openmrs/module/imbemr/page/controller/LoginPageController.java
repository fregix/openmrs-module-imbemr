...
public class LoginPageController {
    ...
    public String get(PageModel model,
                      ...
                      @CookieValue(value = ImbEmrWebConstants.COOKIE_NAME_LAST_SESSION_LOCATION, required = false) String lastSessionLocationId,
        ...
        String redirectUrl = ObjectUtil.nvlStr(pageRequest.getRequest().getSession().getAttribute(ImbEmrWebConstants.SESSION_ATTRIBUTE_REDIRECT_URL), "");
        pageRequest.getRequest().getSession().removeAttribute(ImbEmrWebConstants.SESSION_ATTRIBUTE_REDIRECT_URL);

        if (StringUtils.isBlank(redirectUrl)) {
            redirectUrl = pageRequest.getRequest().getParameter(ImbEmrWebConstants.REQUEST_PARAMETER_NAME_REDIRECT_URL);
        }
        if (StringUtils.isBlank(redirectUrl)) {
        ...
        model.addAttribute(ImbEmrWebConstants.REQUEST_PARAMETER_NAME_REDIRECT_URL, redirectUrl);
        ...
        try {
            ...
            systemLocations = Context.getLocationService().getAllLocations();
    ...
    public String post(@RequestParam(value = "username", required = false) String username,
        ...
        String redirectUrl = pageRequest.getRequest().getParameter(ImbEmrWebConstants.REQUEST_PARAMETER_NAME_REDIRECT_URL);
        ...
        if (sessionLocationId != null) {
            ...
            pageRequest.setCookieValue(ImbEmrWebConstants.COOKIE_NAME_LAST_SESSION_LOCATION, sessionLocationId.toString());
        }
        ...
        try {
            ...
            if (Context.isAuthenticated()) {
                ...
                if (sessionLocation != null && httpSession!=null) {
                    httpSession.setAttribute(ImbEmrWebConstants.SESSION_LOCATION_ID, sessionLocation.getId());
                }
        ...
        pageRequest.getSession().setAttribute(ImbEmrWebConstants.SESSION_ATTRIBUTE_REDIRECT_URL, redirectUrl);
