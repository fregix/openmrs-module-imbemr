...
public class HomePageController {
	...
	public String overrideHomepage() {
		return "forward:/" + ImbEmrConstants.MODULE_ID + "/home.page";
	}
    ...
    public Object controller(PageModel model,
        ...
        model.addAttribute("extensions",
                appFrameworkService.getExtensionsForCurrentUser(ImbEmrConstants.HOME_PAGE_EXTENSION_POINT_ID, contextModel));
